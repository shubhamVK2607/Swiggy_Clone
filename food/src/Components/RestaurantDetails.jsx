...
const RestaurantDetails = ({ restaurant }) => {
  ...
  const darkForText=isDarkMode?"text-white":"text-gray-500"
    ...
    <div className={"w-full my-[2rem] mr-[2rem] py-[2rem] pr-[2rem] "}>
      <div className="flex justify-between">
        <div>
          ...
          <h1 className={"text-xs "+darkForText}>
            {restaurant.cuisines.join(", ")}
          </h1>
          <div className="flex">
            <h1 className={"text-xs "+darkForText}>{restaurant.areaName},</h1>
            <h1 className={"text-xs mx-1 "+darkForText}>
          ...
          <div className="flex my-2">
            ...
            />
            <h1 className={"mt-2 text-sm "+darkForText}>
